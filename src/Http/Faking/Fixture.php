...
use Salette\Helpers\FixtureHelper;
...
class Fixture
{
     ...
     */
    public function through(\Closure $through): self
    {
     ...
     * @throws FixtureException
     */
    public function store(RecordedResponse $recordedResponse): self
    {
    ...
    protected function swapSensitiveHeaders(RecordedResponse $recordedResponse): RecordedResponse
    {
        ...
        $recordedResponse->headers = FixtureHelper::recursivelyReplaceAttributes(
