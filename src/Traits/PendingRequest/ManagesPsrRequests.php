...
namespace Salette\Traits\PendingRequest;
...
trait ManagesPsrRequests
{
     ...
     */
    protected ?FactoryCollection $factoryCollection = null;
    ...
    public function getUri(): UriInterface
    {
        ...
        // and then we'll merge in Salette's query parameters. Our query parameters will take
