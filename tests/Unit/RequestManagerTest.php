...
use Salette\Managers\RequestManager;
...
use Salette\Tests\Fixtures\Requests\UserRequestWithBoot;
use Salette\Tests\Fixtures\Requests\ReplaceConfigRequest;
use Salette\Tests\Fixtures\Requests\ReplaceHeaderRequest;
use Salette\Tests\Fixtures\Requests\TrailingSlashRequest;
use Salette\Tests\Fixtures\Requests\NoTrailingSlashRequest;
use Salette\Tests\Fixtures\Requests\UserRequestWithBootConnector;
...
//});
//
//test('if a request fails you can get the original error from the SaletteException', function () {
//    $request = new ErrorRequest();
//
//    $response = $request->send();
//
